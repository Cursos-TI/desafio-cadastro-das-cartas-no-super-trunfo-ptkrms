...
int main() {
    ...
    scanf(" %c", &estado1);
    printf("Digite o código da carta 1 usando o nome do estado com o nome da cidade. A combinação forma o código da carta (ex: A01, B02): ");
    ...
    scanf(" %c", &estado2);
    printf("Digite o código da carta 2 usando o nome do estado com o nome da cidade. A combinação forma o código da carta (ex: A01, B02): ");
